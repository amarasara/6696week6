...
<br>
  ...
  <label for="inputEmail3" class="col-sm-2 col-form-label">ชนิด</label>
    ...
    <div class="row mb-3">
  <label for="inputEmail3" class="col-sm-2 col-form-label">สายพันธ์ุ</label>
    <div class="col-sm-3">
      <input type="taxt" class="form-control" id="inputPassword3"name="ิิbreed">
    </div>
  </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ิิbreed=$_POST["ิิbreed"];
    $age=$_POST["age"];
    
try {
 
    $sql = "INSERT INTO pet (name, species,	ิิbreed, age)
    VALUES ('$name', ' $species','$ิิbreed', '$age')";
